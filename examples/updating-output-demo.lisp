...
(defpackage "UPDATING-APP"
  (:use :clim :clim-lisp)
  (:export "APP-MAIN"))

(in-package :updating-app)

(define-application-frame updatingapp ()
...
(define-updatingapp-command (com-add :name t) ((number 'integer))
...
(define-updatingapp-command (com-next :name t) ()
...
(define-updatingapp-command (com-previous :name t) ()
...
(define-updatingapp-command (com-quit :name t) ()
...
(defun app-main ()
  ...
  (run-frame-top-level (make-application-frame 'updatingapp)))
